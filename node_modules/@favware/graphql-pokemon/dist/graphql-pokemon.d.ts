...
declare type AbilitiesResolvers<ContextType = any, ParentType extends ResolversParentTypes['Abilities'] = ResolversParentTypes['Abilities']> = {
...
declare type AbilityResolvers<ContextType = any, ParentType extends ResolversParentTypes['Ability'] = ResolversParentTypes['Ability']> = {
    ...
    pokemonThatHaveThisAbility?: Resolver<ReadonlyArray<Maybe<ResolversTypes['Pokemon']>>, ParentType, ContextType>;
...
declare type CatchRateResolvers<ContextType = any, ParentType extends ResolversParentTypes['CatchRate'] = ResolversParentTypes['CatchRate']> = {
...
declare type EvYieldsResolvers<ContextType = any, ParentType extends ResolversParentTypes['EvYields'] = ResolversParentTypes['EvYields']> = {
...
declare type FlavorResolvers<ContextType = any, ParentType extends ResolversParentTypes['Flavor'] = ResolversParentTypes['Flavor']> = {
    flavor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    game?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type GenderResolvers<ContextType = any, ParentType extends ResolversParentTypes['Gender'] = ResolversParentTypes['Gender']> = {
    female?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    male?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type GenerationalPokemonLearnsetResolvers<ContextType = any, ParentType extends ResolversParentTypes['GenerationalPokemonLearnset'] = ResolversParentTypes['GenerationalPokemonLearnset']> = {
    generation3?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    generation4?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    generation5?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    generation6?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    generation7?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    generation8?: Resolver<ResolversTypes['PokemonLearnset'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type ItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['Item'] = ResolversParentTypes['Item']> = {
    bulbapediaPage?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
declare type LearnsetResolvers<ContextType = any, ParentType extends ResolversParentTypes['Learnset'] = ResolversParentTypes['Learnset']> = {
...
declare type LearnsetLevelUpMoveResolvers<ContextType = any, ParentType extends ResolversParentTypes['LearnsetLevelUpMove'] = ResolversParentTypes['LearnsetLevelUpMove']> = {
...
declare type LearnsetMoveResolvers<ContextType = any, ParentType extends ResolversParentTypes['LearnsetMove'] = ResolversParentTypes['LearnsetMove']> = {
    generation?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    move?: Resolver<ResolversTypes['Move'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type MoveResolvers<ContextType = any, ParentType extends ResolversParentTypes['Move'] = ResolversParentTypes['Move']> = {
...
declare type PokemonResolvers<ContextType = any, ParentType extends ResolversParentTypes['Pokemon'] = ResolversParentTypes['Pokemon']> = {
    ...
    learnsets?: Resolver<Maybe<ResolversTypes['GenerationalPokemonLearnset']>, ParentType, ContextType>;
    ...
    species?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    sprite?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    types?: Resolver<ReadonlyArray<ResolversTypes['PokemonType']>, ParentType, ContextType>;
    weight?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
declare type PokemonLearnsetResolvers<ContextType = any, ParentType extends ResolversParentTypes['PokemonLearnset'] = ResolversParentTypes['PokemonLearnset']> = {
    dreamworldMoves?: Resolver<Maybe<ReadonlyArray<ResolversTypes['LearnsetMove']>>, ParentType, ContextType>;
    eggMoves?: Resolver<Maybe<ReadonlyArray<ResolversTypes['LearnsetMove']>>, ParentType, ContextType>;
    eventMoves?: Resolver<Maybe<ReadonlyArray<ResolversTypes['LearnsetMove']>>, ParentType, ContextType>;
    levelUpMoves?: Resolver<Maybe<ReadonlyArray<ResolversTypes['LearnsetLevelUpMove']>>, ParentType, ContextType>;
...
declare type PokemonTypeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PokemonType'] = ResolversParentTypes['PokemonType']> = {
...
declare type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
    ...
    getAllPokemon?: Resolver<ReadonlyArray<ResolversTypes['Pokemon']>, ParentType, ContextType, RequireFields<QueryGetAllPokemonArgs, 'offset' | 'offsetFlavorTexts' | 'reverse' | 'reverseFlavorTexts' | 'take' | 'takeFlavorTexts'>>;
    ...
    getTypeMatchup?: Resolver<ResolversTypes['TypeMatchup'], ParentType, ContextType, RequireFields<QueryGetTypeMatchupArgs, 'primaryType'>>;
};
declare type StatsResolvers<ContextType = any, ParentType extends ResolversParentTypes['Stats'] = ResolversParentTypes['Stats']> = {
    attack?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    defense?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    hp?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    specialattack?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
declare type TypeEffectivenessResolvers<ContextType = any, ParentType extends ResolversParentTypes['TypeEffectiveness'] = ResolversParentTypes['TypeEffectiveness']> = {
...
declare type TypeMatchupResolvers<ContextType = any, ParentType extends ResolversParentTypes['TypeMatchup'] = ResolversParentTypes['TypeMatchup']> = {
    attacking?: Resolver<ResolversTypes['TypeEffectiveness'], ParentType, ContextType>;
    defending?: Resolver<ResolversTypes['TypeEffectiveness'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export { Abilities, AbilitiesEnum, AbilitiesResolvers, Ability, AbilityResolvers, CatchRate, CatchRateResolvers, DirectiveResolverFn, EvYields, EvYieldsResolvers, Exact, Flavor, FlavorResolvers, Gender, GenderResolvers, GenerationalPokemonLearnset, GenerationalPokemonLearnsetResolvers, InputMaybe, IsTypeOfResolverFn, Item, ItemResolvers, ItemsEnum, Learnset, LearnsetLevelUpMove, LearnsetLevelUpMoveResolvers, LearnsetMove, LearnsetMoveResolvers, LearnsetResolvers, MakeMaybe, MakeOptional, Maybe, Move, MoveResolvers, MovesEnum, NextResolverFn, Pokemon, PokemonEnum, PokemonLearnset, PokemonLearnsetResolvers, PokemonResolvers, PokemonType, PokemonTypeResolvers, Query, QueryGetAbilityArgs, QueryGetAllPokemonArgs, QueryGetFuzzyAbilityArgs, QueryGetFuzzyItemArgs, QueryGetFuzzyLearnsetArgs, QueryGetFuzzyMoveArgs, QueryGetFuzzyPokemonArgs, QueryGetItemArgs, QueryGetLearnsetArgs, QueryGetMoveArgs, QueryGetPokemonArgs, QueryGetPokemonByDexNumberArgs, QueryGetTypeMatchupArgs, QueryResolvers, RequireFields, Resolver, ResolverFn, ResolverTypeWrapper, ResolverWithResolve, Resolvers, ResolversParentTypes, ResolversTypes, Scalars, Stats, StatsResolvers, SubscriptionObject, SubscriptionResolveFn, SubscriptionResolver, SubscriptionResolverObject, SubscriptionSubscribeFn, SubscriptionSubscriberObject, TypeEffectiveness, TypeEffectivenessResolvers, TypeMatchup, TypeMatchupResolvers, TypeResolveFn, TypesEnum };
